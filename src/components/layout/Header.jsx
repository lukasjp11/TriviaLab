    ...
    <header className="sticky top-0 z-40 bg-white dark:bg-gray-800 shadow-sm dark:shadow-gray-900/20">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center text-blue-600 dark:text-blue-400">
              ...
              <h1 className="text-xl md:text-2xl font-bold ml-1.5 text-gray-800 dark:text-white">
                Trivia<span className="text-blue-600 dark:text-blue-400">Forge</span>
              </h1>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-4">
            <a 
              href="https://github.com/username/triviaforge" 
              target="_blank" 
      ...
      {menuOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -10 }}
          className="md:hidden bg-white dark:bg-gray-800 py-2 shadow-lg"
        >
          <div className="container mx-auto px-4">
            <div className="flex flex-col space-y-1">
              ...
              <button
                onClick={toggleTheme}
                className="flex items-center gap-1.5 px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
              >
                {darkMode ? (
                  <>
                    <Sun size={18} />
